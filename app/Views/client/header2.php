...
<!-- Mirrored from template.hasthemes.com/flosun/flosun/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jan 2024 14:02:57 GMT -->
<head>
    <meta charset="utf-8">
                                ...
                                <li class="menu-item-has-children"><a href="#">Shop</a>
                                    <ul class="megamenu dropdown">
                                        ...
                                        <li class="mega-title has-children"><a href="#">Product Details</a>
                                            <ul class="dropdown">
                                                <li><a href="variable-variable-product-details.html">Single Product Details</a></li>
                                                <li><a href="variable-variable-product-details.html">Variable Product Details</a></li>
                                                <li><a href="external-variable-product-details.html">External Product Details</a></li>
                                                <li><a href="gallery-variable-product-details.html">Gallery Product Details</a></li>
                                                <li><a href="countdown-variable-product-details.html">Countdown Product Details</a></li>
                                            </ul>
                                        </li>

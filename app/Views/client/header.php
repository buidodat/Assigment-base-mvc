...
<!-- Mirrored from template.hasthemes.com/flosun/flosun/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Jan 2024 14:03:06 GMT -->
<head>
    <meta charset="utf-8">
                                ...
                                <li>
                                    ...
                                    <ul class="dropdown-submenu dropdown-hover">
                                        <?php 
                                            ...
                                            $listdm = DanhMucModel::all();
                                            foreach($listdm as $dm):
                                        ?>
                                        <li><a href="shop?ma_dm=<?=$dm->ma_dm?>"><?=$dm->ten_dm?></a></li>
                                        <?php endforeach; ?>
                                    </ul>
                                </li>
                                <li>
                                ...
                                <li class="minicart-wrap">
                                    ...
                                    <div class="cart-item-wrapper dropdown-sidemenu dropdown-hover-2">
                                        ...
                                        <div class="cart-links d-flex justify-content-between">
                                            <a class="btn product-cart button-icon flosun-button dark-btn" href="about">View cart</a>
                                            <!-- <a class="btn flosun-button secondary-btn rounded-0" href="checkout.html">Checkout</a> -->
                                        </div>
                                    </div>
                                </li>
                                <li class="minicart-wrap">
                                    <a href="login" class="minicart-btn toolbar-btn">

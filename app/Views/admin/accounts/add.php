...
<form action="<?=ROOT_PATH?>admin/account/create" method="post" enctype='multipart/form-data'>
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="cap_bac" id="vaiTroAdmin" value="1" checked>
                                <label class="form-check-label" for="vaiTroAdmin">Quản Trị Viên</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="cap_bac" id="vaiTroUser" value="0" >
